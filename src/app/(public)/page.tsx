...
export default function HomePage() {
  ...
  // Fetch top 3 featured services from Firestore
  useEffect(() => {
  ...
  // Fetch latest 6 gallery images from Firestore
  useEffect(() => {
              ...
              {featuredServices.map((service) => (
                ...
                >
                  <div className="relative h-48 bg-gray-100">
                    <img 
                      src={service.image_urls?.[0] || 'data:image/svg+xml,%3Csvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 300"%3E%3Crect fill="%23e5e7eb" width="400" height="300"/%3E%3Ctext x="50%25" y="50%25" dominant-baseline="middle" text-anchor="middle" font-size="20" fill="%239ca3af"%3EImage not available%3C/text%3E%3C/svg%3E'} 
                      alt={service.name} 
